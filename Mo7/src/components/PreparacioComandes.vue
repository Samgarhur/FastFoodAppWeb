<template>
  <v-container>
    <v-card v-for="comanda in comandes" :key="comanda.id" :class="posarColorComandes(comanda.temps)">
      ...
      <v-expand-transition>
        <v-card v-if="mostrarDetalls && comandaSeleccionada == comanda.id" class="v-card--reveal" style="height: 100%;">
